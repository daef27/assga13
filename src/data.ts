...
export interface Parceiro {
  id: number;
  nome: string;
  tipo: 'Parceiro Institucional' | 'Apoiador Esportivo' | 'Patrocinador' | 'Apoio Comunitário';
  logo_url: string;
  link_url?: string;
  descricao?: string;
  ordem: number;
...
export interface Voluntario {
  ...
  status: 'Novo' | 'Em Análise' | 'Aprovado' | 'Contatado';
}

export const parceiros: Parceiro[] = [
  {
    id: 1,
    nome: 'Prefeitura de São Gonçalo do Amarante',
    tipo: 'Parceiro Institucional',
    logo_url: '/imagens/parceiros/sga-prefeitura.svg',
    link_url: 'https://saogoncalo.rn.gov.br/',
    descricao: 'Apoio institucional e cessão dos espaços esportivos públicos municipais.',
    ordem: 1,
    ativo: false,
  },
  {
    id: 2,
    nome: 'FPDS - Federação Potiguar de Desporto de Surdos',
    tipo: 'Apoiador Esportivo',
    logo_url: '/imagens/parceiros/fpds.svg',
    link_url: 'https://fpds.org.br',
    descricao: 'Filiação desportiva e organização de copas e etapas regionais de surdos.',
    ordem: 2,
    ativo: false,
  },
  {
    id: 3,
    nome: 'CBDS - Confederação Brasileira de Desportos de Surdos',
    tipo: 'Apoiador Esportivo',
    logo_url: '/imagens/parceiros/cbds.svg',
    link_url: 'https://cbds.org.br',
    descricao: 'Entidade máxima do surdodesporto brasileiro filiada ao ICSD.',
    ordem: 3,
    ativo: false,
  },
  {
    id: 4,
    nome: 'FENEIS - Federação Nacional de Educação e Integração dos Surdos',
    tipo: 'Parceiro Institucional',
    logo_url: '/imagens/parceiros/feneis.svg',
    link_url: 'https://feneis.org.br',
    descricao: 'Defesa dos direitos linguísticos em LIBRAS e cidadania da pessoa surda.',
    ordem: 4,
    ativo: false,
  },
  {
    id: 5,
    nome: 'SEMJEL - Secretaria Municipal de Juventude, Esporte e Lazer',
    tipo: 'Apoiador Esportivo',
    logo_url: '/imagens/parceiros/semjel.svg',
    link_url: 'https://saogoncalo.rn.gov.br/',
    descricao: 'Fomento aos treinos de futsal, voleibol e atletismo da comunidade surda.',
    ordem: 5,
    ativo: false,
  },
];

export const mensagensContato: MensagemContato[] = [
  {
    id: 1,
    nome: 'Fernanda Martins de Oliveira',
    email: 'fernanda.martins@email.com',
    telefone: '(84) 99876-5432',
    mensagem: 'Gostaria de saber como funciona o processo de matrícula para novos atletas surdos no futsal e os dias dos treinos.',
    data_envio: '2026-09-08 14:30',
    status: 'Pendente',
  },
  {
    id: 2,
    ...
    mensagem: 'Parabéns pelo trabalho na ASSGA! Gostaria de propor uma parceria com nossa academia para apoio aos atletas.',
    data_envio: '2026-09-10 10:15',
    status: 'Respondida',
  },
];
...
export const voluntarios: Voluntario[] = [
  {
    id: 1,
    nome: 'Juliana Beatriz Cabral',
    email: 'juliana.cabral@email.com',
    telefone: '(84) 99432-1098',
    idade: 26,
    mensagem: 'Sou estudante de Letras LIBRAS na UFRN e quero atuar como voluntária de apoio em eventos e acolhimento de famílias!',
    data_cadastro: '2026-09-05 16:20',
    status: 'Aprovado',
  },
  {
    id: 2,
    nome: 'Danilo Rocha de Medeiros',
    email: 'danilo.medeiros@gmail.com',
    telefone: '(84) 99182-7364',
    idade: 31,
    mensagem: 'Tenho experiência com fotografia e cobertura de eventos esportivos, me coloco à disposição da diretoria esportiva da ASSGA.',
    data_cadastro: '2026-09-11 09:45',
    status: 'Novo',
  },
];
